const CONSTANTS = {
    MODULE_ID: "token-note-hover-pin",
    PATH: `modules/token-note-hover-pin/`,
    MODULE_TITLE: "Token Note Hover Pin",
    PATH_TRANSPARENT: `modules/token-note-hover-pin/assets/transparent.png`,
    PATH_PDF_THUMBNAIL: `modules/token-note-hover-pin/assets/file-pdf-solid.svg`,
    FLAGS: {
